...
public class SlideDateTimePicker {
    ...
    public void setNoOfTabs(int noOfTabsInDialog) {
        noOfTabs = noOfTabsInDialog;
    }
    ...
    public static class Builder {
        ...
        public Builder setTabPosition(int tabPosition) {
       ...
       public Builder setNoOfTabs(int noOfTabs) {
        ...
        public SlideDateTimePicker build() {
            ...
            picker.setTabPosition(tabPosition);
            picker.setNoOfTabs(noOfTabs);
